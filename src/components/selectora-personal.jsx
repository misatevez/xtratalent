    ...
    (
        <main
          ...
          <div className="flex items-center space-x-4">
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Alta personal</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Buscar personal</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Crear entidades</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Buscar entidades</Button>
          </div>
        </main>
    )
  );
