  ...
  return (
    (
        <main
          ...
          <Button  disabled={!permisos.tipoGrupoCorporativo} onClick={() => router.push('/dashboard/entidades/tipogrupocorporativo')} className="bg-white text-purple-500 hover:bg-gray-200 m-3">Tipo Grupo Corporativo</Button>
            <Button  disabled={!permisos.grupoCorporativo} onClick={() => router.push('/dashboard/entidades/gruposcorporativos')} className="bg-white text-purple-500 hover:bg-gray-200 m-3">Grupos Corporativos</Button>
            <Button  disabled={!permisos.subtipoEntidad} onClick={() => router.push('/dashboard/entidades/subtipoentidad')} className="bg-white text-purple-500 hover:bg-gray-200 m-3">Subtipo Entidad</Button>
