    ...
    (
        <main
          ...
          <div className="flex items-center space-x-4 justify-center">
            ...
            <Button  onClick={() => router.push('/dashboard/entidades/entidadempresa/buscarentidadempresa')}className="bg-white text-purple-500 hover:bg-gray-200">Buscar Entidades</Button>
          </div>
        </main>
    )
  );
