...
export function SelectoraContenido() {
  ...
  return (
    (
        <main
          ...
          <h1 className="text-4xl font-bold mb-6 text-center">Tipos de contenido</h1>
          <div className="flex items-center justify-center space-x-4">
            <Button onClick={() => router.push('/dashboard/evaluaciones/evaluacion')} className="bg-white text-purple-500 hover:bg-gray-200">Listar contenido</Button>
