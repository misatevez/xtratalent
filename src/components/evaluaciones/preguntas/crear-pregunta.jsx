...
export default function CrearPregunta() {
    return (
        <div key="1" className="p-8 space-y-8 mt-8 mb-8 mx-auto max-w-7xl">
        ...
        <span className="font-bold mt-2">Tema-Contenido:</span>
        <span className="mt-2" >Excel 365 - 2023</span>
        <br />
        <span className="font-bold">Características y Detalle de la Pregunta:</span>
        <div>
          <div>
