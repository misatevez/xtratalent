    ...
    (
        <main
          ...
          <div className="flex items-center justify-center space-x-4">
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Crear Temas</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Buscar Temas</Button>
