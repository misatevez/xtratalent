...
export default function FormEvaluacion({ formState, handleInputChange, handleSubmit, titulo, handleSelectChange }) {
...
console.log(formState)
  ...
  const handleGrupoTipoChange2 = (id_subcategoria) => {
    // Actualiza el estado del formulario para incluir el nuevo id de tipo de grupo seleccionado
    handleInputChange({ target: { name: 'id_subcategoria', value: id_subcategoria } });
  };
    ...
    return (
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div className="grid col-span-full">
          ...
          <input
           name="nombre" value={formState.nombre} onChange={handleInputChange}
...
/>
        ...
        <div className="flex flex-col">
          ...
          <Select onValueChange={(value) => handleSelectChange(value, 'nivel')} value={formState.nivel}>
  ...
  <SelectContent position="popper">
    {niveles.map((nivel, index) => (
      <SelectItem key={index} value={nivel.valor}>{nivel.nombre}</SelectItem>
    ))}
  </SelectContent>
</Select>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="flex flex-col">
          ...
          <Select onValueChange={(value) => handleSelectChange(value, 'clase')} value={formState.clase}>
  <SelectTrigger id="group-type">
    <SelectValue placeholder="Seleccione uno" />
  </SelectTrigger>
      ...
      <SelectItem key={index} value={nivel.valor}>{nivel.nombre}</SelectItem>
        ...
        <div className="grid grid-cols-2 col-span-full gap-4 mb-4 ">
            ...
            <div>
              ...
              <input
                 name="duracion" value={formState.duracion} onChange={handleInputChange}
                className="border p-2"
                id="duracion"
                placeholder="80"
                type="number"
  ...
  Limite de tiempo
          ...
          <div className="grid grid-cols-2 ">
            <div>
              ...
              <input
                name="calificacion" value={formState.calificacion} onChange={handleInputChange}
                className="border p-2"
                id="duracion"
                placeholder="80"
                type="number"
...
<label className="font-semibold" htmlFor="activa">
  Evaluacion Activa
      ...
      <div className="mb-4">
        ...
        <textarea
          name="instrucciones" value={formState.instrucciones} onChange={handleInputChange}
          className="w-full border p-2"
          id="instrucciones"
      ...
      <div className="mb-4">
        ...
        <textarea
          name="areas" value={formState.areas} onChange={handleInputChange}
          className="w-full border p-2"
          id="instrucciones"
