    ...
    (
        <main
          ...
          <div className="flex items-center justify-center space-x-4">
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Crear Categoria</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Buscar Categoria</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Asignar Categoria</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Subcategorias</Button>
          </div>
        </main>
    )
  );
