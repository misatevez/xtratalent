 ...
 * @see https://v0.dev/t/EKVF7NmtIEz
 */
  ...
  return (
    (
        <main className="p-8 space-y-8 mt-8 mb-8 mx-auto max-w-7xl">
          <h1 className="text-4xl font-bold mb-6 text-center text-blue-400">Configuraciones</h1>
          ...
          <div className="flex items-center gap-6 mb-4">
            ...
            <div className="flex flex-col gap-4 w-full">
              <label className="flex flex-col gap-2">
                <span className="text-lg font-semibold">Subir logo</span>
