  ...
  return (
    (
        <main
          ...
          <h1 className="text-4xl font-bold mb-6 text-center">Secciones</h1>
          <div className="flex items-center space-x-4">
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Evaluaciones</Button>
            <Button className="bg-white text-purple-500 hover:bg-gray-200">Categorias</Button>
