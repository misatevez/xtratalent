 ...
 * @see https://v0.dev/t/0YwEnSuTORR
 */
  ...
  return (
    (
        <main>
          ...
          <div
            className="grid grid-cols-2 gap-4 mt-4 mx-4 my-6 bg-gray-100 p-4 rounded-lg shadow-lg">
            <Card>
              <CardContent className="flex flex-col items-center justify-center">
                <UsersIcon className="w-6 h-6 text-black" />
                <p className="text-lg font-bold mt-2">Usuarios registrados</p>
                <p className="text-2xl font-bold mt-2">1500</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex flex-col items-center justify-center">
                <UsersIcon className="w-6 h-6 text-black" />
                <p className="text-lg font-bold mt-2">Usuarios internos</p>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center">
                <UsersIcon className="w-6 h-6 text-black" />
                <p className="text-lg font-bold mt-2">Usuarios externos</p>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center">
                ...
                <p className="text-lg font-bold mt-2">Entidades</p>
                <p className="text-2xl font-bold mt-2">200</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex flex-col items-center justify-center">
                <ViewIcon className="w-6 h-6 text-black" />
                <p className="text-lg font-bold mt-2">Evaluaciones creadas</p>
