    ...
    (
        <main
          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <Button  disabled={!permisos.busquedaRapido} onClick={() => router.push('/dashboard/personal/busquedaavanzada')} className="bg-white text-purple-500 hover:bg-gray-200">Busqueda avanzada</Button>
          </div>
        </main>
    )
  );
