...
import ListaDirecciones from '@/components/entidades/entidadempresa/subentidades/areas-direcciones/lista-direcciones';
import ListaDepartamentos from '@/components/entidades/entidadempresa/subentidades/areas-direcciones/departamento/lista-departamento';
...
import ListaRenglones from '@/components/entidades/puestos/renglones-presupuestarios/lista-renglones';
  ...
  useEffect(() => {
    ...
    const fetchVacante = async () => {
        ...
        if (error) {
            ...
            setFormState(data);
            setSelectedEntidad(data.id_entidad_empresa);
            setSelectedSubEntidad(data.id_sub_entidad);
            setSelectedDireccion(data.id_direcciones);
            setSelectedDepartamento(data.id_departamentos);
            console.log('Esta es la data' + data.id_departamentos);
        }
        setLoading(false);
    };
    fetchVacante();
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      ...
      setNotification({
        visible: true,
        titulo: "Éxito",
        mensaje: "Se ha actualizado su vacante" // Ajusta según necesites
      });
    }
  };
      ...
      <div className="rounded-lg shadow-lg">
        <div className="bg-white p-6 rounded-lg shadow-inner m-auto">
          <form onSubmit={handleSubmit}>
            <div>
              <h2 className="text-lg font-bold  mb-4">Modificar Vacante</h2>
