...
export default function Page({ params }) {
  ...
  const handleGuardar = async (e) => {
    ...
    setTimeout(() => {
      router.push('/dashboard/entidades/puestos/vacantes/buscardireccion');
    }
    , 2000);
  ...
  const handleEvaluaciones = (value) => {
    ...
    // Verificar si ya existe una evaluación con el mismo id
    const evaluacionExistente = selectedEvaluaciones.find(
      (evaluacion) => evaluacion.id === id_evaluacion
    );
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <Input
                  ...
                  id="group-name"
                  placeholder="Ejemplo: Vacante de especialista en ventas"
                />
              </div>
              <div className="mt-4">
                <label
                ...
                <textarea
                  ...
                  placeholder="La dirección web para la vacante de especialista en ventas..."
                  rows="4"
                />
              </div>
