...
import FormEntidadEmpresa from "@/components/entidades/entidadempresa/FormEntidadEmpresa";
    ...
    const fetchUserDetails = async () => {
      if (slug) {
        ...
        const { data, error } = await supabase
          .from('entidad_empresa')
          .select('*')
          .eq('id_entidad_empresa', slug)
          .single();
